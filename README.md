...
To create a project assembly jar, simple change the directory to ```QuantumFactorization/QuantamFactorization``` and where "mvnw" or "mvnw.cmd" file is located, and then execute the normal package phase from the default lifecycle, as shown below
...
![Simulator GUI](QuantamFactorization/src/main/resources/simulator.PNG "Simulator GUI")
...
![Simulator GUI](QuantamFactorization/src/main/resources/consoleoutput.PNG "Simulator Console")
...
### Readme
The readme file is located [here](https://github.com/jamiemal/QuantumFactorization/blob/master/README.md). It has a detailed description of the quantum factorization application and software development methodologies used.  
